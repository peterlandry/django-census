...
class Value(object):
    ...
    def __div__(self, other):
        ...
        div_result = self._value / other._value
        return Value(div_result, moe=self._calc_moe(other, '/', result_value=div_result))
...
class Table(object):
    ...
    def __call__(self, geo, use_cache=False):
        ...
        if self.operation:
            ...
            result = self.datasource.get_value(self.table, geo)
            if len(result) == 0:
                return None
