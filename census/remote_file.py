# for RemoteFileObject, from https://github.com/migurski/census-tools
...
class RemoteFileObject:
    ...
    def get_length(self):
        ...
        if self.verbose:
            print >> sys.stderr, length, 'bytes in', os.path.basename(self.rest)
        ...
        while count:
            ...
            if chunk_offset not in self.chunks:
                ...
                if self.verbose:
                    ...
                    print >> sys.stderr, '%.1f%%' % min(100, 100 * loaded),
                    print >> sys.stderr, 'of', os.path.basename(self.rest),
                    print >> sys.stderr, 'with', timedelta(seconds=remain), 'to go'
